...
\begin{figure}[htb]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.8\textwidth]{manualmul}
...
\begin{figure}[htb]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.8\textwidth]{manualmuline}
...
\begin{figure}[htb]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.9\textwidth]{manualreducedtime}
...
\begin{figure}[htb]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.75\textwidth]{kremlinreducedtime}
