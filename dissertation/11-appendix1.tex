...
\lstinputlisting[label={code:onmulkremlinreport},caption={Kremlin's indication of the blocks that should be parallelised and theorical variables that where calculated for Mult algorithm version},firstline=160, lastline=174]{./codes/onMultKremlin.txt}

\subsection{Kremlin report for Matrix Multiplication, MultLine version }

\lstinputlisting[label={code:onmulinekremlinreport},caption={Kremlin's indication of the blocks that should be parallelised and theorical variables that where calculated for MultLine algorithm version},firstline=163, lastline=181]{./codes/onMultLineKremlin.txt}
