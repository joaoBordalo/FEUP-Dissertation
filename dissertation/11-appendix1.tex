\chapter{Appendices} \label{chap:chap7}
...
\lstinputlisting[label={code:kremlincompile},caption={Program compiled and profiled by Kremlin with both Mult and MultLine algorithms, written in C++}]{./codes/matrixmulforkremlin.cpp}
